            ...
            {option.choices?.map((choice) => {
              ...
              return option.name === "Color" ? (
                ...
                >
                  ...
                  {disabled && (
                    <div className="absolute w-10 h-[2px] bg-yellow-400 rotate-45 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
                  )}
                </li>
              ) : (
                <li
                  ...
                  style={{
                    ...
                    backgroundColor: selected
                      ...
                      ? "#ffff80"
                      : "white",
                    color: selected || disabled ? "white" : "#f8cf17",
